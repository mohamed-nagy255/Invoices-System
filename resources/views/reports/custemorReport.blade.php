                                                ...
                                                <form action="{{ route('report.search') }}" method="POST" role="search"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="type">
                                                            <p class="mg-b-10">تحديد نوع العملاء</p>
                                                            <select class="form-control select2" name="type" required>
                                                                <option value="{{ $type ?? 'حدد نوع العملاء' }}" selected>
                                                                    {{ $type ?? 'حدد نوع العملاء' }}
                                                                </option>
                                                                <option value="مدفوعة">العملاء المدفوعة</option>
                                                                <option value="غير مدفوعة">العملاء الغير مدفوعة</option>
                                                                <option value="مدفوعة جزئيا">العملاء المدفوعة جزئيا
                                                                </option>
                                                            </select>
                                                        </div><!-- col-4 -->
