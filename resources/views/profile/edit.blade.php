            ...
            @if (session('status') === 'password-updated' or session('status') === 'profile-updated')
                <div class="col-12 my-4">
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                        <strong>تم تحديث البيانات بنجاح. <i class="fe fe-20 fe-check-circle"></i></strong> <button
                    ...
                    <form method="post" action="{{ route('password.update') }}">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <p class="small text-muted mb-2"> لإنشاء كلمة مرور جديدة، عليك استيفاء جميع المتطلبات
                                    التالية: </p>
